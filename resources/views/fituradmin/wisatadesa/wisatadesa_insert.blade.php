            ...
            <div class="card card-info card-outline">
                <div class="card-header bg-primary text-white">
                    <div class="card-tools">
                        <center><h3>Tambah Wisata Desa</h3></center>
                    </div>
                </div>

                <div class="card-body">
                    <form action="{{route('wisatadesa_post')}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <input type="number" id="typeNumber" class="form-control" name="harga" placeholder="Harga Paket Trip"/>
                        </div>
                        <div class="form-group">
