     ...
     <div class="container-fluid" >
        <div class="content">
            <div class="card card-info card-outline">
                ...
                <div class="card-body">
                    <form action="{{route('wisatadesa_post_edit',$editt->id)}}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <input type="number" id="typeNumber" class="form-control" name="harga" placeholder="Harga Tiket Masuk"/>
                        </div>
                        <div class="form-group">
