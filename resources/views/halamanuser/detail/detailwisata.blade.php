  ...
  <!-- Page Heading -->
    <div class="container bg-white text-black shadow mb-5 mt-5" style="border-radius: 20px; width:80%">
        ...
        <div class="col-5 align-self-center">
                <center><img class="mr-4 shadow" src="{{ asset('image_tempatwisata')}}/{{$detail->gambar}}"
                ...
                <div class="col-7">
                    ...
                    <div class="row mt-4">
                        <h4 style="color:black">Harga Tiket</h4>
                    </div>
                        <div class="row">
                    ...
                    <div class="row mt-4">
                        ...
                        <i style="color: black; font-style:normal; text-align:justify">{{$detail->lokasitempat}}</i></center>
                    </div>
                    </div>                         
                </div>
                </div>
