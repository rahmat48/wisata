...
<div class="login-box">
  <div class="login-logo">
    <a href="{{route('home')}}"><strong><h1 class="fw-bolder" style="color: rgb(48, 48, 48)">Selamat Datang</h1></strong>  </a>
  </div>
  <!-- /.login-logo -->
  <div class="card " >
    <div class="card-body login-card-body" style="border-radius: 10px;">
      <p class="login-box-msg">Mulai Perjalananmu</p>
      @if ($errors->any())
      ...
      <form action="{{route('postlogin')}}" method="post">
        ...
        <div class="row">
          ...
          <div class="col align-self-center">
            <i><button type="submit" class="btn btn-primary btn-block">Masuk</button></i>
          </div>
          <!-- /.col -->
        </div>
      </form>
